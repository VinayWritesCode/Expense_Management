      ...
      </div>
      {
        contactInfo.map(item => {
          return <div key={item.id}>
            <MessageCard first_name={item.first_name} last_name={item.last_name} profile_photo={item.profile_photo} subject={item.subject} message={item.message} datetime={item.datetime} />
          </div>
        })
      }
    </div>
